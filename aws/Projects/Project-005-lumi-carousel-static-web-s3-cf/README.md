# Project-005 : lumi Carousel Static Website deployed on AWS Cloudfront, S3 and Route 53 using Cloudformation
...
```text
005-lumi-carousel-static-web-s3-cf (folder)
|
...
![Project 005 : lumi Carousel Application Snapshot](./project-005-snapshot.png)
