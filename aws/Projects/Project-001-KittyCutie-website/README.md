<<<<<<< HEAD
# Project-001 : Kittens Carousel Static Website deployed on AWS EC2 using Cloudformation
...
![Project_001](Pro_Project_001.png)
...
```
001-kittens-carousel-static-website-ec2 (folder)
|
